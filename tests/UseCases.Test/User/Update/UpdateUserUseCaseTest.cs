...
namespace UseCases.Test.User.Update
{
    public class UpdateUserUseCaseTest
    {
        ...
        private static UpdateUserUseCase CreateUseCase(StudyFlow.Domain.Entities.User user, string? email = null)
        {
            ...
            {
                userReadOnlyRepository.IsEmailRegisteredAndActive(email);
            }

            return new UpdateUserUseCase(loggedUser, userReadOnlyRepository.Build(), userUpdateOnlyRepository, unitOfWork);
        }
    }
}
