...
{
    public class ChangePasswordInvalidTokenTest : StudyFlowClassFixture
    {
        ...
        public async Task Error_Empty_Token(string culture)
        {
            ...
            var response = await DoPut(endpoint: _endpoint, request, token: string.Empty, culture: culture);
        ...
        public async Task Error_Invalid_Token(string culture)
        {
            ...
            var response = await DoPut(endpoint: _endpoint, request, token: "InvalidToken", culture: culture);
        ...
        public async Task Error_Token_With_User_Not_Found(string culture)
        {
            ...
            var response = await DoPut(endpoint: _endpoint, request, token: token, culture: culture);
