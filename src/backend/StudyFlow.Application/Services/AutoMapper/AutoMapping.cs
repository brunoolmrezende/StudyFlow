    ...
    public class AutoMapping : Profile
    {
        ...
        private void RequestToDomain()
        {
            ...
            CreateMap<RequestCreateTopicJson, Domain.Entities.Topic>()
                .ForMember(dest => dest.SubjectId, opt => opt.MapFrom(source => _idEncoder.Decode(source.SubjectId).ToList().FirstOrDefault()));
            ...
            CreateMap<RequestCreateReviewJson, Domain.Entities.Review>()
                .ForMember(dest => dest.TopicId, opt => opt.MapFrom(source => _idEncoder.Decode(source.TopicId).ToList().FirstOrDefault()))
